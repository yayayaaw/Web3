...
const Hero = () => {
  ...
  return (
    <section id="hero-top" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-20">
        ...
        <FadeIn delay={600} className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
          <button onClick={() => scrollToSection('menu')} className="w-full sm:w-auto px-8 py-4 bg-white text-[#2C241B] text-sm tracking-widest uppercase hover:bg-[#F9F7F3] transition-colors duration-300">
            Lihat Menu
          </button>
          <button onClick={() => scrollToSection('location')} className="w-full sm:w-auto px-8 py-4 border border-white/50 text-white text-sm tracking-widest uppercase backdrop-blur-sm bg-white/5 hover:bg-white/10 transition-colors duration-300">
            Kunjungi Kami
          </button>
        </FadeIn>
      </div>
