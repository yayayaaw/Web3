...
const defaultContent = {
  ...
  // Galeri sekarang array bebas — bisa tambah/hapus foto sepuasnya dari CMS
  gallery: [
    ...
    "https://images.unsplash.com/photo-1507133750070-4ed4b58b2204?q=80&w=1000&auto=format&fit=crop",
  ...
  testimonials: [
    { id: 't1', quote: "Salah satu cafe dengan desain interior paling indah yang pernah saya kunjungi. Kopinya luar biasa, dan suasananya benar-benar membuat betah untuk menyelesaikan pekerjaan.", author: "Sarah A." },
    { id: 't2', quote: "Tempat favorit buat kerja santai sambil ngopi. Wifi kenceng, tempat duduk nyaman, dan staff-nya ramah banget.", author: "Budi P." },
    { id: 't3', quote: "Menu makanannya enak-enak, terutama burrata salad-nya. Bakal balik lagi bawa teman-teman.", author: "Rani K." },
    { id: 't4', quote: "Suasana paling cozy buat weekend brunch. Fotonya juga instagramable banget di setiap sudut.", author: "Dimas W." },
    { id: 't5', quote: "V60 di sini beneran juara, biji kopinya fresh dan baristanya paham banget racikan yang pas.", author: "Nadia F." },
    { id: 't6', quote: "Servicenya cepat, tempatnya bersih, harga sesuai sama kualitas. Recommended buat meeting santai.", author: "Andra S." },
  ],
