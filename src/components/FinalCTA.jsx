  ...
  return (
    <section className="relative py-32 md:py-48 flex items-center justify-center overflow-hidden text-center">
      ...
      <div className="relative z-10 px-6 max-w-2xl mx-auto">
        ...
        <FadeIn delay={400}>
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-block px-10 py-4 bg-white text-[#2C241B] text-sm tracking-widest uppercase hover:bg-[#F9F7F3] transition-colors duration-300">
            Reservasi Meja
          </a>
        </FadeIn>
      </div>
